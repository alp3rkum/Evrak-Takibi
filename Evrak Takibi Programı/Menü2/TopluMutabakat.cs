...
{
    public partial class TopluMutabakat : Form
    {
        private string musteriAd;
        private string musteriTipi;
        public TopluMutabakat()
        {
            InitializeComponent();
        }
        ...
        private void button_getir_Click(object sender, EventArgs e)
        {
            ...
            {
                DosyaGoster dosyaGoster = new DosyaGoster(5, musteriAd, musteriTipi, false);
                dosyaGoster.Show();
            }
            else
            {
        ...
        private void TopluMutabakat_Load(object sender, EventArgs e)
        {
            string query = "";
