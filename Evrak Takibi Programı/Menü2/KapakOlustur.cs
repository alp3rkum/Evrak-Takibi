...
{
    public partial class KapakOlustur : Form
    {
        ...
        private void button_save_Click(object sender, EventArgs e)
        {
            ...
            {
                DosyaGoster dosyaGoster = new DosyaGoster(2, musteriAdi, musteriTipi, false);
                dosyaGoster.Show();
            }
            else
            {
        ...
        private void button_fatf_Click(object sender, EventArgs e)
        {
            DosyaGoster dosyaGoster = new DosyaGoster(3, musteriAdi, musteriTipi, false);
            dosyaGoster.Show();
        }

        private void button_risk_Click(object sender, EventArgs e)
        {
            DosyaGoster dosyaGoster = new DosyaGoster(4, musteriAdi, musteriTipi, false);
            dosyaGoster.Show();
        }

        private void KapakOlustur_Load(object sender, EventArgs e)
        {
            string query = "";
